...
exports.databases = {
    mongo:{
        "name":"CONFIG",
        // "config":"mongodb://127.0.0.1:27017/configs"
        "config":"mongodb://conf_admin:Config123001@s-2ze589940278d414.mongodb.rds.aliyuncs.com:3717/hyb_config"
    }
}

exports.logger = {
    categoryName: 'hyb',// 日志分类的名字
    level       : 'error',// 日志记录级别
};
